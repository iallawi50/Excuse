    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex items-center justify-between mt-4">
            ...
            <label for="remember_me" class="inline-flex items-center">
                ...
                <span class="mr-2 text-sm text-gray-600">{{ __('ابقاء تسجيل الدخول') }}</span>
            </label>

            <x-primary-button class="ml-3 bg-teal-800 hover:bg-teal-700 focus:ring-teal-500 active:bg-teal-500">
                {{ __('دخول') }}
            </x-primary-button>
        </div>
    </form>
